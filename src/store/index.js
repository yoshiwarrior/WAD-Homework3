...
export default createStore({
    ...
    postList: [
      {
          "authorName": "Basti",
          "content": "ghg",
          "imageUrl": "https://github.com/yoshiwarrior/WAD-Homework1/blob/main/assets/img/basti.gif?raw=1",
      ...
      },
      {
          "authorName": "Basti",
          "content": "O-O",
          "imageUrl": "https://github.com/yoshiwarrior/WAD-Homework1/blob/main/assets/img/verghg.webp?raw=1",
      ...
      },
      {
          "authorName": "Basti",
          "content": "Nett hier",
          "imageUrl": "https://github.com/yoshiwarrior/WAD-Homework1/blob/main/assets/img/nett-hier.webp?raw=1",
      ...
      },
      {
          ...
          "content": "",
          "imageUrl": "https://github.com/yoshiwarrior/WAD-Homework1/blob/main/assets/img/lindner.jpeg?raw=1",
      ...
      },
      {
          ...
          "imageUrl": "https://github.com/yoshiwarrior/WAD-Homework1/blob/main/assets/img/tiksu.jpg?raw=1",
      ...
      },
      {
          ...
          "imageUrl": "https://github.com/yoshiwarrior/WAD-Homework1/blob/main/assets/img/wir-kaufen-dein-auto.jpg?raw=1",
      ...
      },
      {
          ...
          "content": "Tartu 2022",
          "imageUrl": "https://github.com/yoshiwarrior/WAD-Homework1/blob/main/assets/img/tartu2024.jpg?raw=1",
  ...
  getters: {
    getProductList: state => { return state.postList}

  },
  mutations: {
    RESET_LIKES: state => { state.postList.forEach(post => post.likes = 0) },
    ADD_LIKE: (state, index) => { state[index].likes++ }
  },
  actions: {
    resetLikes() {
      commit('RESET_LIKES')
